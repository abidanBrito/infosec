...
# enter your code here
    ...
    # Get last _next state from public IV
    last_state = struct.unpack('<I', iv[12 : 16])[0]
    
    # Update _next
    last_seed = (last_state * 1103515245) + 12345    
    srand(last_seed)

    # Add first state to the key
    key = b'' + struct.pack('<I', last_seed & 0x7fffffff)
    
    # Add remaining 12 bytes to the key
    for i in range(3):
